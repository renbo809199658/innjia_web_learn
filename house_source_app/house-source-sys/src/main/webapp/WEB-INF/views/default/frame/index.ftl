...
<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    ...
    <script type="text/javascript" src="${basePath }/public/hplus-4.1.0/js/contabs.min.js"></script>
...
<div class="wrapper1">
    ...
    <div id="page-wrapper">
        ...
        <div class="row J_mainContent" id="content-main">
    		<iframe class="J_iframe" name="iframe0" type="text/html" width="100%" height="100%" src="${basePath }/admin/index/home.do" frameborder="0" data-id="${basePath }/admin/index/home.do" seamless></iframe>
		</div>
    </div>
    <!--右侧边栏开始-->
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${basePath }/public/hplus-4.1.0/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="my-modal">
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="common-modal-with-body">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
...
<script>
	$(function () {
		$("#content-main").height($("body").height()-50);
	});
	$(window).bind("resize",
    		function() {
				$("#content-main").height($("body").height()-50);
