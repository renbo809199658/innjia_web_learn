		...
		<div class="ibox-content">
			...
			<div class="common-search">
				<div class="form-group">
					...
					<div class="">
						<input type="text" class="form-control" name="methodName" value="${search.methodName}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label">关键字：</label>
					<div class="">
						<input type="text" class="form-control" name="methodTagName" value="${search.methodTagName}" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label">所属菜单：</label>
					<div class="">
						${common.getSelectByMenuAll("menu.id",search.menu.id)}
					</div>
				</div>
				<div class="form-group">
...
<div class="ibox">
    <div class="ibox-title">
    	<div class="page-toolbar form-inline">
    		<div class="btn-group">
    			<a option="modalAdd" href="${basePath}/admin/menuMethod/add.do?navTabId=saveMenuMethod" class="btn btn-outline btn-default"><i class="fa fa-plus"></i> 新建</a>
				<a option="selectDelete" href="${basePath}/admin/menuMethod/batchDelete.do?navTabId=${navTabId}" class="btn btn-outline btn-default"><i class="fa fa-trash"></i> 删除</a>
				
				<div class="form-group" style="margin-left:10px;">
					<form id="search-bar">
						<input type="text" class="form-control" name="methodName" value="" placeholder="功能名" />
						<input type="text" class="form-control" name="methodTagName" value="" placeholder="关键字" />
						<button class="btn btn-primary btn-sm " type="button" onclick="search('search-bar')"> 搜索</button>
					</form>
				</div>
				<a option="selectModalEdit" href="${basePath}/admin/menuMethod/edit.do?navTabId=editMenuMethod&id={sid_obj}" class="btn btn-outline btn-default"><i class="fa fa-paste"></i> 编辑</a>
			
			</div>
			<div class="pull-right">
				<a class="right-sidebar-toggle btn btn-outline btn-default" type="button" aria-expanded="false" ><i class="fa fa-search"></i> 更多搜索</a>
			</div>
    	</div>
    </div>
    <div class="ibox-content">
...
//搜索
	...
	var options = {
        url:"${basePath}/admin/menuMethod/list.do",
        tableId:"table",
        addurl:"${basePath}/admin/menuMethod/add.do",//添加界面url,实现添加不可少
        editurl:"${basePath}/admin/menuMethod/edit.do",//编辑界面url，实现编辑不可少
        updateurl:"${basePath}/admin/menuMethod/update.do",//更新url，实现更新不可少
        deleteurl:"${basePath}/admin/menuMethod/batchDelete.do",//删除url，实现删除不可少
        pager:"#pager",
        prmNames: {
             		sort: "sort",
             		order: "order",
        ...
        colModel: [
			...
			},
			{
				...
				formatter: function (value, grid, rows, state) {
					var editBtn = "<a option='modalEdit' href='${basePath}/admin/menuMethod/edit.do?navTabId=editMemberInfo&id=" + rows.id +"' class='btn btn-default btn-xs'><i class='glyphicon glyphicon-edit'></i> 编辑</a>";
					return editBtn;
				}
			}
		]
