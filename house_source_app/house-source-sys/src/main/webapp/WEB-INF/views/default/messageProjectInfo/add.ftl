...
<div class="ibox">
	...
	<div class="pageContent">
		<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/messageProjectInfo/save.do" >
		<div class="pageFormContent">
			<div class="row">
				...
				<div class="form-group col-md-6 col-sm-6">
					...
					<div class="col-md-9 col-sm-9 input-group">
						<input class="form-control" name="projectPhotoUrl" type="text"/>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
