...
<div class="ibox">
	...
	<div class="pageContent">
		<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/messageSmsAccount/save.do" >
		<div class="pageFormContent">
			<div class="row">
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">账户名称：</label>
					<div class="col-md-9 col-sm-9 input-group">
						<input class="form-control" name="accountNo" type="text" required/>
				...
				<div class="form-group col-md-6 col-sm-6">
					...
					<div class="col-md-9 col-sm-9 input-group">
						<input class="form-control" name="accountPassword" type="text" required />
						<span class="glyphicon glyphicon-info-sign form-control-feedback" aria-hidden="true"></span>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					...
					<div class="col-md-9 col-sm-9 input-group">
						<input class="form-control" name="serveCode" type="text"/>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">项目名称：</label>
					<div class="col-md-9 col-sm-9 input-group">
						${common.getMsgProjectIds("projectInfo.id","")}
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">渠道名称：</label>
					<div class="col-md-9 col-sm-9 input-group">
						${common.getMsgSmsChannels("smsChannel.id","")}
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
