...
<div class="ibox">
	<div class="ibox-title">
    	<h4 class="pull-left"><label>项目功能关系新建</label></h4>
    	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    </div>
    <div class="ibox-content">
	<div class="pageContent">
		<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/moduleUrlRelation/save.do">
		<div class="pageFormContent">
			<div class="row">
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">项目名称：</label>
					<div class="col-md-9 col-sm-9 input-group">
						${common.getProjectIds("projectId","")}
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">接口名称：</label>
					<div class="col-md-9 col-sm-9 input-group">
						${common.getModuleFunctionIds("moduleFunctionId","")}
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
