...
<div class="ibox">
    <div class="ibox-title">
    	<h4 class="pull-left"><label>角色编辑</label></h4>
    	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    </div>
    	<div class="ibox-content">
    		<div class="pageContent">
    			<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/role/update.do" >
    				<input type="hidden" name="id" value="${model.id}"/>
    				<div class="pageFormContent">
    					<div class="form-group col-md-12 col-sm-12">
							<label class="col-md-2 col-sm-2 control-label">角色名称：</label>
							<div class="col-md-9 col-sm-9">
								<input class="form-control" name="roleName" value="${model.roleName}" type="text" />
							</div>
						</div>
						<div class="form-group col-md-12 col-sm-12">
						...
						<div class="form-group col-md-12 col-sm-12">
							...
							<div class="col-md-9 col-sm-9">
								${common.getSelectByRole("objectLookup.id","${model.upId}",0)}
							</div>
						</div>
    				</div>
    				<div class="formBar">
