...
<script>
	...
	var options = {
        url:"${basePath}/admin/smsSendData/list.do",
        tableId:"table",
        pager:"#pager",
        prmNames: {
             		sort: "sort",
        ...
        colModel: [
			...
			},
			{
				...
				formatter: function (value, grid, rows, state) {
					var editBtn = "<a option='modalDetail' href='${basePath}/admin/smsSendData/detail.do?navTabId=detail&id=" + rows.id +"' class='btn btn-primary btn-sm'><i class='glyphicon glyphicon-info-sign'></i> 详细</a>";
					return editBtn;
				}
			}
		]
