...
<div class="ibox">
	<div class="ibox-title">
    	<h4 class="pull-left"><label>公司新建</label></h4>
    	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    </div>
    <div class="ibox-content">
	<div class="pageContent">
		<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/thirdCompanyInfo/save.do" >
		<div class="pageFormContent">
			<div class="row">
				...
				<div class="form-group col-md-6 col-sm-6">
					...
					<div class="col-md-9 col-sm-9 input-group">
						<input class="form-control" name="companyNumber" type="text" required />
						<span class="glyphicon glyphicon-info-sign form-control-feedback" aria-hidden="true"></span>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
