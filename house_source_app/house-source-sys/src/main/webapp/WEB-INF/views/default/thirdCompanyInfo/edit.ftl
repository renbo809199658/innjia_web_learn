...
<div class="ibox">
	...
	<div class="pageContent">
		<form class="form-horizontal m-t" id="ajaxForm" method="post" action="${basePath }/admin/thirdCompanyInfo/update.do" >
		<input type="hidden" name="id" value="${model.id}"/>
		<div class="pageFormContent">
			<div class="row">
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">公司名称：</label>
					<div class="col-md-9 col-sm-9">
						<input class="form-control" name="companyName" value="${model.companyName}" type="text" required/>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">公司编码：</label>
					<div class="col-md-9 col-sm-9">
						<input class="form-control" name="companyNumber" value="${model.companyNumber}" type="text" required/>
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
					<label class="col-md-3 col-sm-3 control-label">公司地址：</label>
					<div class="col-md-9 col-sm-9">
						<input class="form-control" name="companyAddress" value="${model.companyAddress}" type="text" required />
					</div>
				</div>
				<div class="form-group col-md-6 col-sm-6">
